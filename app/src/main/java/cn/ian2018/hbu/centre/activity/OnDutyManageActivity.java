...
import cn.ian2018.hbu.centre.fragment.OnDutyFragmentFactory;

/**
 * 值班情况
 */

public class OnDutyManageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_on_duty_manage);
    ...
    private class ShortPagerAdapter extends FragmentPagerAdapter {
        public String[] mTilte = {"值班时长","签到记录"};
        ...
        public BaseFragment getItem(int position) {
            BaseFragment fragment = OnDutyFragmentFactory.createFragment(position);
            return fragment;
        }
