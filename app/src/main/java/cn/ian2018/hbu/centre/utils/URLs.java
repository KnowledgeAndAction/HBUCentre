...
/**
 * Created by 陈帅 on 2017/10/21/021.
 */
...
public class URLs {
     ...
     * 主机地址
     */
    private static final String HOST_ADDRESS = "http://123.206.57.216:8080/";

    /**
     * 登录
     */
    public static final String LOGIN = HOST_ADDRESS + "HBUCentreInterface/login.do";
    /**
     * 检测更新
     */
    public static final String UPDATE = HOST_ADDRESS + "HBUCentreInterface/getUpdateInfo.do";
    /**
     * 获取云子上的活动
     */
    public static final String GET_ACTIVE_BY_YUNZI = HOST_ADDRESS + "HBUCentreInterface/getActivity.do";
    /**
     * 获取管理员添加的活动
     */
    public static final String GET_ACTIVE_BY_ACCOUNT = HOST_ADDRESS + "HBUCentreInterface/getActivityByAccount.do";
    /**
     * 添加活动
     */
    public static final String ADD_ACTIVE = HOST_ADDRESS + "HBUCentreInterface/addActivity.do";
    /**
     * 修改活动
     */
